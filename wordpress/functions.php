...
// function hide_shipping_methods_based_on_total( $available_methods ) {
//     global $woocommerce;
//     $cart_total = $woocommerce->cart->subtotal;

//     // If cart total is less than 200, show both shipping methods
//     if ( $cart_total < 200 ) {
//         return $available_methods;
//     }

//   // If cart total is greater than or equal to 200, hide all shipping methods except for free shipping
//     foreach ( $available_methods as $shipping_method ) {
//         if ( 'free_shipping:3' != $shipping_method->get_id() ) {
//             unset( $available_methods[ $shipping_method->get_id() ] );
//         }
//     }
...
add_filter( 'woocommerce_package_rates', 'hide_shipping_methods_based_on_total', 10, 1 );
